...
if ( 1 < count( $available_methods ) ) : ?>
	<ul class="shipping" data-title="<?php echo esc_attr( $package_name ); ?>" id="shipping_method">
...
<?php elseif ( 1 === count( $available_methods ) ) :  ?>
	<?php
		...
		printf( '<p class="linebreak">Shipping: %3$s <input type="hidden" name="shipping_method[%1$d]" data-index="%1$d" id="shipping_method_%1$d" value="%2$s" class="shipping_method" /></p>', $index, esc_attr( $method->id ), wc_cart_totals_shipping_method_label( $method ) );
		do_action( 'woocommerce_after_shipping_rate', $method, $index );
	?>
